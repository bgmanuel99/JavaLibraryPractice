...
class VideoGamesOnLoanTest {
	...
	public void testGetGameModes() {
		...
		VideoGamesOnLoan videogame = new VideoGamesOnLoan("World of Warcraft", 23, "November", 2004, "Rol", "Massively multiplayer online", "8.2.4", composers, developers, platforms);
