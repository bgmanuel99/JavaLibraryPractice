...
public class Library {
	...
	public boolean searchVideogameByName(String videogame) {
		for(LoanObjects elem : loanObjects) {
			if(elem.getName().equals(videogame)) return true;
		}
	...
	public void userEdition(boolean changeFirstName, boolean changeLastName, boolean changeSex, boolean changeEmail,
			                boolean changePassword, String newFirstName, String newLastName, String newSex, String newEmail,
			                String newPassword, String ID) {
		for(User elem : users) {
			if(elem.getID().equalsIgnoreCase(ID)) {
